...
function onCreate()
	...
	makeLuaSprite('sky', 'antipathy/scary/sky', -500, -400)
	setScrollFactor('sky', 0.3, 0.3)

     makeLuaSprite('build', 'antipathy/scary/tunnelback', -900, -750)
	setScrollFactor('build', 0.4, 0.4)
     scaleObject('build', 1.1, 1.1)

	makeLuaSprite('stones', 'antipathy/scary/tunnelfloor', -700, -620)
